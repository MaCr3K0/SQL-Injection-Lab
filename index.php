...
<ul>
	...
	<li><a href="transactions9.php?id=1029322123394505">SQL injection 101-Solventado</a><br>
	La consulta SELECT * FROM transactions WHERE id = '<strong>$id</strong>'ya no es vulnerable;<br><br>
